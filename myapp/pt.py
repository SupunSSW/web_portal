...
#     img = cv.imread("/opt/lampp/htdocs/nb-web-app/webcamImage/" + str(frame), 0)
...
# for x in gotdata:
#     frame = cv.imread("/opt/lampp/htdocs/nb-web-app/webcamImage/" + str(x))
